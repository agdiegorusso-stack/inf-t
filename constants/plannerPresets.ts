...
standardNurseRequirements['Me'] =  [1, 1, 1, 1, 1, 1, 1];
...
standardNurseRequirements['Pc'] =  [0, {min: 2, max: 3}, {min: 2, max: 3}, {min: 2, max: 3}, {min: 2, max: 3}, {min: 2, max: 3}, 0];
standardNurseRequirements['Pe'] =  [0, 1, 1, 1, 1, 1, 0];
...
standardNurseRequirements['Pu'] =  [0, {min: 1, max: 2}, {min: 1, max: 2}, {min: 1, max: 2}, {min: 1, max: 2}, {min: 1, max: 2}, 0];
